variable "project_id" {
  description = "GCP project ID for v1 SQL API migration stack."
  type        = string
}
...
variable "spanner_instance_name" {
  description = "Spanner instance name for v1 migration."
  type        = string
}
...
variable "spanner_database_name" {
  description = "Spanner database name for v1 migration target."
  type        = string
}

variable "spanner_database_ddl" {
  description = "DDL statements for tables/indexes needed by v1 mappings."
  type        = list(string)
  default     = []
}
